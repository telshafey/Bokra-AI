...
import { OffboardingTemplate } from '../types';
...
const OffboardingTemplatesPage: React.FC<OffboardingTemplatesPageProps> = ({ templates, onSave, onDelete }) => {
    ...
    return (
        <div className="space-y-6">
            <PageHeader
                title={t('pageTitles.offboardingTemplates')}
                subtitle="إنشاء وإدارة قوالب المهام للموظفين المغادرين."
                actionButton={
